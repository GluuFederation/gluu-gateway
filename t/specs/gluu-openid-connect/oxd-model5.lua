...
model = {
    ...
    -- #9 Get new access token failed so go for authentication
    {
        expect = "/get-authorization-url",
        required_fields = {
            "oxd_id",
    ...
    -- #12
    {
        ...
        response = {
            authorization_url = "https://stub.com/oxauth/restv1/authorize?response_type=code&client_id=@!1736.179E.AA60.16B2!0001!8F7C.B9AB!0008!A2BB.9AE6.AAA4&redirect_uri=https://192.168.200.95/callback&scope=openid+profile+email+uma_protection+uma_authorization&state=473ot4nuqb4ubeokc139raur13&nonce=lbrdgorr974q66q6q9g454iccmqwerty&acr_values=superhero",
        }
    },
    -- #13
    {
        ...
        response = {
            ...
            id_token_claims = {
                ...
                sub = "john doe",
                iss = "https://<op-hostname>",
                nonce = "lbrdgorr974q66q6q9g454iccmqwerty",
                acr = "superhero",
            }
        },
        response_callback = function(response, request_json)
