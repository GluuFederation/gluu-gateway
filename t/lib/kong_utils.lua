...
_M.kong_postgress_custom_plugins = function(opts)
    ...
    sh("docker run --rm ",
        ...
        " -v ", opts.host_git_root, "/setup/templates/nginx-gluu.conf:/usr/local/openresty/nginx/gluu-http-include.conf ",
        " -e KONG_NGINX_HTTP_INCLUDE=/usr/local/openresty/nginx/gluu-http-include.conf ",
