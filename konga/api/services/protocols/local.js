  ...
  sails.models.user
    ...
    .exec(function onExec(error, user) {
      if (error) {
        ...
        sails.log(new Date(), "Passport:Policy:local:findUser =>",user)
        sails.models.passport
          .findOne({
            protocol: 'local',
            user: user.id
          ...
          .exec(function onExec(error, passport) {
            sails.log(new Date(), "Passport:Policy:local:findUserPassport:error =>",error)
            sails.log(new Date(), "Passport:Policy:local:findUserPassport =>",passport)
            if (passport) {
