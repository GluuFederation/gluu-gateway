...
(function () {
  ...
  angular.module('frontend.logs')
    .controller('LogsController', [
      '_', '$scope', '$q', '$log', 'SocketHelperService', '$state', '$uibModal',
      'DialogService', 'LogModel', 'ListConfig', '_items', '_count',
      function controller(_, $scope, $q, $log, SocketHelperService, $state, $uibModal,
                          DialogService, LogModel, ListConfig, _items, _count) {
        LogModel.setScope($scope, false, 'items', 'itemCount');

        // Add default list configuration variable to current scope
        $scope = angular.extend($scope, angular.copy(ListConfig.getConfig('log', LogModel)));
